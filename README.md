...
```bash
go get -u github.com/aka-mj/iothub
```

To install CLI applications:

```bash
GO111MODULE=on go get -u github.com/aka-mj/iothub/cmd/{iothub-service,iothub-device}
```
...
import (
	...
	"github.com/aka-mj/iothub/iotservice"
)
...
import (
	...
	"github.com/aka-mj/iothub/iotdevice"
	iotmqtt "github.com/aka-mj/iothub/iotdevice/transport/mqtt"
)
...
[cmd/iothub-service](https://github.com/aka-mj/iothub/blob/master/cmd/iothub-service) and [cmd/iothub-device](https://github.com/aka-mj/iothub/blob/master/cmd/iothub-device) are reference implementations of almost all available features.
